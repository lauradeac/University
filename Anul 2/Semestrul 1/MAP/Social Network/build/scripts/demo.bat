...
set DEFAULT_JVM_OPTS="--module-path" "APP_HOME_LIBS_PLACEHOLDER" "--module" "socialnetwork/socialnetwork.HelloApplication"
...
@rem Execute demo
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %DEMO_OPTS%  -classpath "%CLASSPATH%" --module-path "%MODULE_PATH%" --module socialnetwork/socialnetwork.HelloApplication %*
